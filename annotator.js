  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      @media (min-width:760px){
        ...
        body.hcc-ann-review-layout #hcc-phone-sizer{width:min(440px,calc((100dvh - 36px) * 0.46025),calc(100vw - var(--hcc-ann-panel-open) - 44px)) !important;height:min(956px,calc(100dvh - 36px),calc((100vw - var(--hcc-ann-panel-open) - 44px) * 2.17273)) !important;max-width:100% !important;max-height:100% !important;flex:none !important;border-radius:30px;overflow:hidden;box-shadow:0 24px 70px rgba(35,38,47,.18),0 0 0 1px rgba(255,255,255,.8)}
        body.hcc-ann-review-layout.hcc-ann-panel-collapsed #hcc-phone-sizer{width:min(440px,calc((100dvh - 36px) * 0.46025),calc(100vw - var(--hcc-ann-panel-closed) - 44px)) !important;height:min(956px,calc(100dvh - 36px),calc((100vw - var(--hcc-ann-panel-closed) - 44px) * 2.17273)) !important}
